...
export const F1_CardImgPiloto = styled.View`
    height: 374px;
    width: 100%;
...
export const F1_ContainerLogo = styled.View`
    height: auto;
    width: 87%;
...
export const F1_LogoImg = styled.Image.attrs({
    resizeMode: 'contain'
})`
    width: 20%;
    height: 45px;
...
export const F1_ContainerInfoPiloto = styled.View`
    width: 100%;
    flex-direction: row;
...
export const F1_Pais = styled.Text`
    color: #FFF;
    font-size: 16px;
`;
...
export const F1_ContainerCar = styled.TouchableOpacity`
    align-items: center;
    height: 160px;
    width: 100%;
    margin-top: 15px;
...
export const F1_CardBio = styled.View`
    background-color: #37374E;
    width: 100%;
    margin-top: 15px;
    border-radius: 15px;
...
export const F1_ConteinerBio = styled.View`
    background-color: #E00600;
    height: 60px;
    width: 100%;
    border-radius: 15px;
...
export const F1_TituloBio = styled.Text`
    color: #FFF;
    font-size: 20px;
`;

export const F1_TextBio = styled.Text`
    color: #FFF;
    font-size: 16px;
    margin: 15px;
`;